      ...
      {isLoading ? (
        ...
        <View style={{ flex: 1, width: '100%', justifyContent: 'center', alignItems: 'center' }}>
          <Modal
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#eee', padding: 10, margin: 20 }}>
              <TouchableOpacity
                onPress={onTakePhoto}
                style={{ margin: 20, alignItems: 'center', justifyContent: 'center', height: 50, borderRadius: 30, borderWidth: 1, borderColor: '#000', width: '80%' }}>
                <Text style={{ fontSize: 20 }}>Fotoğraf Çek</Text>
              </TouchableOpacity>

              <TouchableOpacity
                onPress={onSelectImagePress}
                style={{ marginBottom: 20, alignItems: 'center', justifyContent: 'center', height: 50, borderRadius: 30, borderWidth: 1, borderColor: '#000', width: '80%' }}>
                <Text style={{ fontSize: 20 }}>Kütüphaneden Seç</Text>
              </TouchableOpacity>

              {isUploading && (
                <View style={{ marginTop: 50, marginBottom: 20, alignItems: 'center', justifyContent: 'center' }}>
          ...
          <TouchableOpacity onPress={() => setShowModal(!showModal)} style={{ width: 100, height: 100, borderRadius: 40, margin: 10 }}>
            <ImageBackground source={{ uri: currentUser.ImageUrl }} imageStyle={{ borderRadius: 50 }} style={{ flex: 1 }}></ImageBackground>
            <View style={{position: 'absolute', bottom: 0, right: 0, width: 36, height: 36, borderRadius: 20, backgroundColor: '#000', borderWidth: 2, alignItems: 'center', justifyContent: 'center', borderColor: '#fff', }}>
          ...
          <TouchableOpacity onPress={signout} style={{ position: 'absolute', top: 30, right: 30, alignItems: 'center', justifyContent: 'center' }}>
